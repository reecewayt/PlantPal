...
set_property PACKAGE_PIN B13 [get_ports arduino_uart_txd]				
	set_property IOSTANDARD LVCMOS33 [get_ports arduino_uart_txd]    
###Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2 		
set_property PACKAGE_PIN F14 [get_ports arduino_uart_rxd]					
	set_property IOSTANDARD LVCMOS33 [get_ports arduino_uart_rxd]
...
set_property PACKAGE_PIN G14 [get_ports i2c_adc_scl]					
	set_property IOSTANDARD LVCMOS33 [get_ports i2c_adc_scl]
###Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports i2c_adc_sda]					
	set_property IOSTANDARD LVCMOS33 [get_ports i2c_adc_sda]
